...
export async function pollOnce() {
    ...
    try {
        ...
        const campaigns = allCampaigns.filter(c => c.is_active && c.execution_mode === 'polling');
    ...
    for (const mediaId of mediaIds) {
        try {
            ...
            for (const comment of comments) {
                ...
                if (await getSetting(processedKey)) continue;
                ...
                if (!matched) {
                    ...
                    await setSetting(processedKey, 'skipped');
                    continue;
                }
                ...
                if (campaign.check_follower) {
                    // TODO: implement follower check properly with async isFollower
                ...
                if (!dmText) {
                    await setSetting(processedKey, 'no_dm_text');
                    continue;
                }
                ...
                try {
                    ...
                    await setSetting(processedKey, 'sent');
                    processed++;
                    ...
                    await setSetting(processedKey, 'failed');
