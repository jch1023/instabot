 ...
 * This is the official way to DM someone who commented on your post
...
export async function sendPrivateReply(accessToken, commentId, message) {
    const url = `${GRAPH_FB_BASE}/me/messages`;
 ...
 */
export async function getUserMedia(accessToken, igUserId, limit = 20) {
 ...
 * Note: This requires instagram_manage_followers permission
 * and the account must have this permission approved via App Review
 */
export async function getFollowers(accessToken, igUserId, after = null) {
