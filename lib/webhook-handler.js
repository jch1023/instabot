    ...
    for (const campaign of campaigns) {
        ...
        if (campaign.check_follower) {
            ...
            try {
                ...
                if (accessToken) {
                    const userProfile = await getUserProfile(accessToken, userId);
                    console.log(`[DEBUG] Profile API Response for @${username}:`, JSON.stringify(userProfile)); // API 응답 확인용 (필수)
