    ...
    for (const campaign of campaigns) {
        ...
        try {
            ...
            if (shouldAttachFollowCta) {
                ...
                try {
                    const ctaSend = await sendDirectButtonTemplate(
                        accessToken,
                        userId,
                        ctaPrompt,
                        {
                    ...
                    followCtaMode = ctaSend?.cta_type === 'web_url' ? 'web_url_template' : 'button_template';
                    followCtaTemplateType = ctaSend?.template_type || null;
                } catch (templateError) {
