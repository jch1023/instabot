    ...
    for (const campaign of campaigns) {
        ...
        try {
            ...
            if (shouldAttachFollowCta) {
                ...
                // Prefer button template CTA for Instagram DM, then quick_reply, then text fallback.
                try {
                    ...
                    followCtaMode = 'button_template';
                } catch (templateError) {
                    console.warn('[Webhook] CTA button template send skipped:', templateError.message);
            ...
            if (shouldAttachFollowCta && followCtaMode === 'none') {
                try {
                    await sendDirectMessage(
                        accessToken,
                        userId,
                    ...
                    console.warn('[Webhook] CTA text fallback send skipped:', fallbackError.message);
                }
            }
